  ...
  <>
    ...
    <button
      ...
      className="
        ...
        transition-colors hover:border-primary/30 hover:bg-secondary
        w-full sm:w-64 md:w-80
      "
    >
      <Search className="h-3.5 w-3.5" />
      <span className="truncate">Search companies...</span>
      <kbd className="ml-auto hidden sm:inline rounded border border-border bg-secondary px-1.5 py-0.5 text-[10px] font-medium">
        ⌘K
      </kbd>
    </button>
